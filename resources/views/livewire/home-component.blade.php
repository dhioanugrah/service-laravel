        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                    ...
                    <img src="{{asset('images/slider')}}/{{$s->image}}" alt="{{$s->tittle}}"
    ...
    <section class="content-central">
        ...
        <div class="content_info">
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2>PoloAgency <span>Choice</span> of Services</h2>
        ...
        <div>
            ...
            <div id="boxes-carousel">
                @foreach ($aservices as $as)
                <div>
                    <a class="g-list" href="{{route('home.service_details',['service_slug'=>$as->slug])}}">
                        <div class="img-hover">
                            <img src="{{asset('images/services/thumbnails')}}/{{$as->thumbnail}}" alt="{{$as->name}}"
                        ...
                        <div class="info-gallery">
                            ...
                            <p>{{$as->tagline}}</p>
                            <div class="content-btn"><a
                                    href="{{route('home.service_details',['service_slug'=>$as->slug])}}"
                                    class="btn btn-primary">Book Now</a></div>
                            <div class="price"><span>&#36;</span><b>From</b>{{$as->price}}</div>
                        </div>
                    </a>
                </div>
                @endforeach
