                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{route('admin.all_service')}}" class="btn btn-info pull-right">All
                                                Services</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="createService">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" wire:model="discount_type">
                                                    ...
                                                    <option value="fixed">Percent</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="inclusion" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="exclusion" class="form-control"
